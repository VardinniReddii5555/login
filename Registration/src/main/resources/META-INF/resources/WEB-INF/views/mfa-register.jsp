        ...
        <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5">
            <div class="card shadow-sm border-0 rounded-4 p-4 p-md-5">
                <div class="text-center mb-4">
                    ...
                    <h3 class="text-center mb-3"> MFA Registration </h3>
                    <p class="text-muted mb-0">     Secure your account using
                    Google Authenticator or Microsoft Authenticator </p>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/mfa-register"  method="post" class="d-grid gap-3">
